 ...
 */
 ...
 $Test->drawGraphBackground(new BackgroundStyle(new Color(255), TRUE));
 ...
 // Finish the graph
 $Test->setFontProperties("../Fonts/tahoma.ttf",8);
 $Test->drawLegend(65,35,$DataSet->GetDataDescription(), new Color(250));
 $Test->setFontProperties("../Fonts/tahoma.ttf",10);
 $Test->drawTitle(60,22,"Example 4", new Color(50),585);
